...
yolov5_weight_file = 'rider_helmet_number_medium.pt' # ... may need full path
helmet_classifier_weight = 'helment_no_helmet98.6.pth'
conf_set=0.35 
frame_size=(800, 480)
head_classification_threshold= 7.0 # make this value lower if want to detect non helmet more aggresively;
